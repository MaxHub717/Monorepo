...
import type { PenaltyStatus, PenaltyType } from '@nexgen/shared';
...
export class PenaltyService {
  ...
  async updatePenaltyStatus(dto: UpdatePenaltyStatusDto, actor?: { id?: string; role?: string; requestId?: string }) {
    ...
    const allowed: Partial<Record<PenaltyStatus, PenaltyStatus[]>> = {
    ...
    const from = existing.status as PenaltyStatus;
    const to = dto.status as PenaltyStatus;
